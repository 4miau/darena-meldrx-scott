<template>
  <DsContainer>
    ...
    <DsDocumentViewer :content-base64="textDocument" content-type="text"/>
    <DsDivider/>
    <DsText size="2xl">
      Html/Text Document Viewer
    </DsText>
    <DsDocumentViewer :content-base64="htmlDocument" content-type="html"/>
    <DsDivider/>
    <DsText size="2xl">
      Image Document Viewer
    </DsText>
    <DsDocumentViewer :content-url="imageDocument" content-type="image"/>
    <DsDivider/>
    <DsText size="2xl">
      PDF Document Viewer
    </DsText>
    ...
    <div>
      <DsButtonGroup v-model="pdfSelection">
        <DsButton :value="0">
          Single Page
        </DsButton>
    ...
    <DsDocumentViewer :content-url="pdfDocuments[pdfSelection]" content-type="pdf"/>
    ...
    <DsDocumentViewer :content="jsonDocument" content-type="json"/>

    <DsDivider/>

    <DsText size="2xl">
      CCDA Document Viewer
    </DsText>

    <div>
      <DsButtonGroup v-model="ccdaSelection">
        <DsButton :value="0">
          Adam
        </DsButton>
    ...
    <DsDocumentViewer :content-url="ccdas[ccdaSelection]" content-type="ccda"/>
  </DsContainer>
</template>

<script setup lang="ts">
const textDocument = "TXMgQWxpY2UgTmV3bWFuIHdhcyB0ZXN0ZWQgZm9yIHRoZSBVcmluYW5hbHlzaXMgbWFjcm8gcGFuZWwgYW5kIHRoZSByZXN1bHRzIGhhdmUgYmVlbiBmb3VuZCB0byBiZSBub3JtYWw="
const htmlDocument= ""
const imageDocument= "https://images.squarespace-cdn.com/content/v1/5c3ce7fc2714e564a6af4b46/1696196764837-IUENTHTHMBH9RDPAAZ8V/DS-Meadow-Home.png?format=2500w"
const pdfDocuments = ["https://cdn.meldrx.com/assets/component-gallery/sample.pdf", "https://cdn.meldrx.com/assets/component-gallery/example-multipage.pdf"]
const jsonDocument = {
    "resource": {
        "resourceType": "Condition",
        "id": "9f0adc90-613b-4652-bc8e-4bd70e38961a",
        "meta": {
            "versionId": "1",
            "lastUpdated": "2024-07-31T14:18:04.591697+00:00",
            "profile": [
        ...
        "subject": {
            "reference": "Patient/9e05d788-88a3-4dba-bbfa-f891b104ae62"
        },
        "onsetPeriod": {
            "start": "2006-12-31T00:00:00.000000Z",
            "end": "2007-06-01T00:00:00.000000Z"
        },
        "abatementDateTime": "2007-06-01T00:00:00.000000Z"
    },
    "response": {
        "status": "200",
        "lastModified": "2024-07-31T14:18:04.791349+01:00"
    }
}

const pdfSelection = ref<number>(0)
const ccdaSelection = ref<number>(0)
				...
				<section>
					...
					<text>
						<list listType="ordered">
							...
							<item>Make an appointment with your doctor to be seen two weeks from the date of your

					procedure.</item>
							<item>You may feel slightly bloated after the procedure because of air that

					was introduced during the examination.</item>
					...
					Pain or redness at the site where the intravenous needle was placed.<br/>
							</item>
							<item>Do not drink alcohol for 24 hours. Alcohol amplifies the effect of the sedatives
...
<!--
 ...
 2015-10 DB: 		-Created 'master doc'
					...
					-Updated to match 170.315_b1_toc_inp_sample2.docx test data using 170.315_b1_toc_amb_sample2.xml as a master doc.
 ...
 ********************************************************
 -->
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="C:XMLCDA_SDTC_SchemainfrastructurecdaCDA_SDTC.xsd"
	...
	<id extension="9dea5d99-ed59-458d-b464-c22839e5d07a" root="2.16.840.1.113883.19.5.99999.1"/>
	<code code="34133-9" displayName="Summarization of Episode Note" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC"/>
	<!-- Title of this document -->
	<title>170.315_b1_toc_gold_sample2 test data</title>

	<effectiveTime value="20150722180000-0500" />
	...
	<recordTarget>
		<patientRole>
			<id root="78A150ED-B890-49dc-B716-5EC0027B3982" extension="852951" assigningAuthorityName="Test EHR" />
			<addr use="HP">
				<!-- HP is "primary home" from codeSystem 2.16.840.1.113883.5.1119 -->
			...
			<providerOrganization>
				<id extension="4948714330" root="2.16.840.1.113883.4.6"/>
	...
	<author>
		<time value="20150722"/>
		<assignedAuthor>
			<id extension="8851602754" root="2.16.840.1.113883.4.6"/>
	...
	<custodian>
		<assignedCustodian>
			<representedCustodianOrganization>
				<id extension="2208744369" root="2.16.840.1.113883.4.6"/>
				<name>Community Health and Hospitals</name>
				<telecom use="WP" value="tel:+1(555)-555-5000"/>
				<addr>
					<streetAddressLine>1002 Healthcare Dr</streetAddressLine>
	...
	<documentationOf>
		<serviceEvent classCode="PCPR">
			...
			<performer typeCode="PRF">
				...
				<assignedEntity>
					<id extension="2458897032" root="2.16.840.1.113883.4.6"/>
	...
	<component>
		<structuredBody>
			...
			<!-- *******************************
			B) Medications Administered during stay
			added section and entry from scratch as per test data requirements
			all data is relevant -db
			***************************** -->
			<component>
				<section>
						...
						<act classCode="ACT" moodCode="EVN">
							...
							<entryRelationship typeCode="SUBJ">
								<observation classCode="OBS" moodCode="EVN">
									...
									<templateId root="2.16.840.1.113883.10.20.22.4.4" extension="2015-08-01"/>
									<templateId root="2.16.840.1.113883.10.20.22.4.4"/>
									<id root="ab1791b0-5c71-11db-9832-0800200c9a69"/>
									...
									<value xsi:type="CD" code="T23.1" codeSystem="2.16.840.1.113883.6.90" displayName="Burn of first degree of wrist and hand" codeSystemName="ICD-10"/>
				...
				<section>
					...
					<text>
						<table border="1" width="100%">
							...
							<tbody>
								<tr>
									<td ID="Proc1">Application of Dressing for burn</td>
									<td>July 22, 2015</td>
								</tr>
							</tbody>
						</table>
			...
			<component>
				<section>
					...
					<text><paragraph ID="Proc2">Patient has no history of implantable devices</paragraph></text>
					<entry>
				...
				<section>
						...
						<table border="1" width="100%">
							...
							<tbody>
								<tr>
									...
									<td ID="vit4">99 degrees Fahrenheit</td>
								</tr>
							</tbody>
						</table>
					</text>
					<entry typeCode="DRIV">
						<organizer classCode="CLUSTER" moodCode="EVN">
							...
							<statusCode code="completed"/>
							<effectiveTime>
								<low value="201507221810-0500"/>
								<high value="201507221810-0500"/>
							</effectiveTime>
							<component>
								<observation classCode="OBS" moodCode="EVN">
					...
					<entry typeCode="DRIV">
						<organizer classCode="CLUSTER" moodCode="EVN">
							...
							<templateId root="2.16.840.1.113883.10.20.22.4.26" extension="2015-08-01"/>
							<templateId root="2.16.840.1.113883.10.20.22.4.26"/>
							<id root="31b73bd0-cffc-4599-902e-dbe54bc56999"/>
							<code code="46680005" codeSystem="2.16.840.1.113883.6.96" codeSystemName="SNOMED CT" displayName="Vital signs">
								<!-- A vitals organizer conformant to both C-CDA 1.1 and C-CDA 2.1 would contain the SNOMED code (46680005) from R1.1 in the root code and a LOINC code in the translation -->
								<translation code="74728-7" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC" displayName="Vital signs"/>
							</code>
			...
			********************************************************
			...
			<component>
				<section>
					...
					<text>The patient Mr Richard Maur was found to have first degree burns and Dr Seven and his staff Mr Maur by cleaning the burn and dressing the burn and observed for couple of hours before discharging Mr Maur.</text>
				</section>
			</component>
				...
				<section>
					...
					<text>
						...
						<table border="1" width="100%">
							...
							<tbody>
								<!-- The two narrative elements can also be combined into a single paragraph -->
								<tr>
									<td>Schedule an appointment with Dr Seven after 1 week for Follow up with Outpatient facility.</td>
									<td>July 29, 2015</td>
								</tr>
								<tr>
									<td>Medication: Tylenol 500mg</td>
									<td>As needed</td>
								</tr>
							</tbody>
						</table>
					</text>
					<!-- This is not required to be coded, this is shown as an example -->
					<entry>
						...
						<encounter classCode="ENC" moodCode="INT">
							...
							<statusCode code="active"/>
							<effectiveTime>
								<!-- represents latest time to go to appointment -db -->
								<low value="20150729"/>
							</effectiveTime>
							<!-- required for test data -db -->
							<performer>
								<assignedEntity>
									<id root="2.16.840.1.113883.19.5.9999.456" extension="2981823"/>
									<addr>
							...
							<entryRelationship typeCode="RSON">
								<observation classCode="OBS" moodCode="EVN">
									...
									<code codeSystem="2.16.840.1.113883.6.96" codeSystemName="SNOMED CT" code="185349003" displayName="encounter for 'check-up' (procedure)"/>
									<text>Schedule an appointment with Dr Seven after 1 week for Follow up with Outpatient facility.</text>
									<statusCode code="completed"/>
									<effectiveTime>
										<low value="20150729"/>
									</effectiveTime>
					...
					<entry>
						...
						<substanceAdministration moodCode="INT" classCode="SBADM">
						  ...
						  <id root="cdbd33f0-6cde-11db-9fe1-0800200c9a66" />
						  <text>In case of high fever, take Tylenol according to the following.</text>
						  <statusCode code="active" />
						  ...
						  <consumable>
							<manufacturedProduct classCode="MANU">
								...
								<templateId root="2.16.840.1.113883.10.20.22.4.23" />
								<manufacturedMaterial>
									<code code="209459" codeSystem="2.16.840.1.113883.6.88" displayName="Tylenol 500mg" codeSystemName="RxNorm"/>
								</manufacturedMaterial>
							</manufacturedProduct>
						  </consumable>
						</substanceAdministration>
			...
			********************************************************
			...
			<!-- Notes Section for History and Physical Note -->
			<component>
            <section>
                <templateId root="2.16.840.1.113883.10.20.22.2.65" extension="2016-11-01"/>
                <id root="15C1B550-00D6-11E6-B041-0050568B0001"/>
                ...
                <text>
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td ID="hpnote_1">Dr Albert Davis examined Mr Billy Maur and found him to be healthy but advised him to cut down on smoking.</td>
                                <td>Dr Albert Davis</td>
                                <td>07/22/2015</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <act classCode="ACT" moodCode="EVN">
                        ...
                        <code code="34109-9" displayName="Note"
                            ...
                            <translation code="34117-2" displayName="History and Physical Note"
                                codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC"></translation>
                        </code>
                        <text>
                            <reference value="#hpnote_1"></reference>
                        </text>
                        <statusCode code="completed"/>
                        <effectiveTime value="20150722"></effectiveTime>
                        <author>
                            <templateId root="2.16.840.1.113883.10.20.22.4.119" />
		        								<time value="201507221100-0500" />
		        								<assignedAuthor>
		            								<id extension="8851602754" root="2.16.840.1.113883.4.6"/>
		            								<assignedPerson>
											            <name>
