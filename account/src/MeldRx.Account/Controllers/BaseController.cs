...
namespace MeldRx.Account.Controllers
{
    ...
    {
        [TempData]
        public string PopupNotificationMessage { get; set; }
        ...
        public async Task<IActionResult> RedirectToMeldRxOidcError(MeldRxOidcErrorCode errorCode)
        {
            ...
            return RedirectToAction(
                ...
                new
                {
                    errorId = await duendeMessageStore.WriteAsync(error)
                }
            );
        }
    }
